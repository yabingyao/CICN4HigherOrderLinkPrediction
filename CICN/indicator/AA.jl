...
function PLP_AA(convey_dict::Convey_class)
    ...
    for wuv in train
        ...
        wuv_scores_dict[Tuple([[w],uv])] = sum([1/log2(col_degree[node] + 0.00001) for node in wuv_cn_dict[Tuple([[w],uv])]])
